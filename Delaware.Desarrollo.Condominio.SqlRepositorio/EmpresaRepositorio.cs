...
namespace Delaware.Desarrollo.Condominio.SqlRepositorio
{
    ...
    {
        public IEnumerable<EmpresasBE> ListarEmpresaPorUsuario(UsuariosBE parametro)
        {
...

            {
                ...
                var coleccion = conexion.Query<EmpresasBE>("dbo.Empresa_ListarPorPersona_pa", param: parametros, commandType: CommandType.StoredProcedure);
